<template>
  <div>
    <el-dialog :visible.sync="dialogVisibleChild"  @close="close" title="新增用户">
      <el-row :gutter="15">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="身份证号码" prop="gmsfhm">
                  <el-input v-model="formData.gmsfhm" placeholder="请输入身份证号码" clearable
                    prefix-icon='el-icon-user' :style="{width: '100%'}"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="警号" prop="jh">
                  <el-input v-model="formData.jh" placeholder="请输入警号" clearable prefix-icon='el-icon-user'
                    :style="{width: '100%'}"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="登录密码" prop="password">
                  <el-input v-model="formData.password" placeholder="请输入登录密码" clearable
                    prefix-icon='el-icon-user' :style="{width: '100%'}"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <dept-cascader prop="deptCode" @handleChange="this.handleChange" :dept-code="deptCode" :dept="dept" :dept-map="deptMap"></dept-cascader>
              </el-col>
            </el-row>
          </el-col>
        </el-form>
